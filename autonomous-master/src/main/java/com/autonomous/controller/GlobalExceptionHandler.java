...
import com.autonomous.model.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AutonomousException.class)
    public ResponseEntity<ErrorResponse> handleEnglishException(AutonomousException e) {
